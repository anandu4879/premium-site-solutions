    ...
    <SiteLayout>
      ...
      <section className="py-20">
        <div className="container-x grid lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-4">
            {contactCards.map(
              (c) => {
                const Inner =
                  (
                    <div className="flex gap-4 rounded-2xl border border-gray-200 bg-white p-5 hover:border-gray-400 hover:shadow-card transition-all">
                      <div className="h-11 w-11 shrink-0 rounded-xl bg-black text-white grid place-items-center transition-colors hover:bg-gray-800">
          ...
          {/* FORM */}
          <div className="lg:col-span-2 rounded-2xl bg-white border border-gray-200 p-6 md:p-10 shadow-card">
        ...
        <div className="container-x mt-16">
          <div className="rounded-3xl overflow-hidden border border-gray-200 shadow-card aspect-16/7">
            <iframe
